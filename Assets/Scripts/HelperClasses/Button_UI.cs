...
//Note: this is one of Sams helper classes, just gives the ability to do some basic action on buttons e.g. hover over change color of a sprite image
// Or set up a delegate function using this class, if wanting to do more than change color of a button on mouse over, you will need to include this namespace in the script
 // and then you will be able to set up listner delegates from this script 
namespace HelperLibrary.UI {
