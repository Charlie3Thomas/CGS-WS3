...
namespace CT.Lookup
{
    ...
    public static class DataSheet
    {
        ...
        public static readonly int      STARTING_SCIENCE                = 5000;
        ...
        public static readonly CTCost SCIENTIST_NET  = new CTCost( 1.0f, -1.0f,  1.0f, 0.0f);
        public static readonly CTCost PLANNERS_NET   = new CTCost( 1.0f,  0.5f,  1.0f, 0.0f);
        public static readonly CTCost FARMERS_NET    = new CTCost( 0.0f,  0.0f, -3.0f, 0.0f);
        ...
        public static readonly Dictionary<CTTechnologies, BuffsNerfs> technology_buffs = new Dictionary<CTTechnologies, BuffsNerfs>()
        {
            ...
            [CTTechnologies.Lockers]                = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                  new List<float>() { 100.0f }),
            [CTTechnologies.DamageMitigation1]      = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                   new List<float>() { 100.0f }),
            [CTTechnologies.DamageMitigation2]      = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                   new List<float>() { 100.0f }),
            [CTTechnologies.Stockpiling]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                   new List<float>() { 100.0f }),
            [CTTechnologies.Revenue]                = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                     new List<float>() { 100.0f}),
            [CTTechnologies.Innovation]             = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                new List<float>() { 0.001f }),
            [CTTechnologies.Construction1]          = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.Construction2]          = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                   new List<float>() { 0.1f }),
            [CTTechnologies.SuperRevenue]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                     new List<float>() { 200.0f }),
            [CTTechnologies.SuperLockers]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                  new List<float>() { 0.001f }),
            [CTTechnologies.Inspiration]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                new List<float>() { 0.001f }),
            [CTTechnologies.Zoning]                 = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.SuperStockpiling]       = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.FinanceManagement]      = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                 new List<float>() { 250.0f }),
            [CTTechnologies.AlarmSystem]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.ResearchCentre]         = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_BONUS },                               new List<float>() { 500.0f }),
            [CTTechnologies.StoreHouse]             = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.SafeHouse]              = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                   new List<float>() { 0.001f }),
            ...
            [CTTechnologies.Digitization]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                  new List<float>() { 350.0f }),
            [CTTechnologies.CropRotation]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.Fertilization]          = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.Alchemy]                = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_BONUS },                               new List<float>() { 750.0f }),
            [CTTechnologies.Seismometer]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.Automation]             = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.FoodTechnology]         = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.InterestBoost]          = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                     new List<float>() { 500.0f }),
            [CTTechnologies.DigitalSeismometer]     = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.Seismography]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.DigitalCurrency]        = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                  new List<float>() { 0.001f }),
            [CTTechnologies.DigitalPayment]         = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                     new List<float>() { 500.0f }),
            [CTTechnologies.Blueprints]             = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.Greenprints]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.NetBanking]             = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.FOOD_GAIN },                                  new List<float>() { 0.001f }),
            [CTTechnologies.ResearchDome]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_BONUS },                               new List<float>() { 2000.0f }),
            [CTTechnologies.RapidRelief]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.SeismicInvisibility]    = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.FloodManagement]        = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.Robotics]               = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                  new List<float>() { 0.001f }),
            [CTTechnologies.Bluffing]               = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                new List<float>() { 0.001f }),
            ...
            [CTTechnologies.Warehousing]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                  new List<float>() { 0.001f }),
            [CTTechnologies.TechnologyCentre]       = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                new List<float>() { 0.001f }),
            [CTTechnologies.LifelineSupport]        = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                   new List<float>() { 0.001f }),
            [CTTechnologies.SupremeFinancing]       = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS },                                     new List<float>() { 1000.0f }),
            [CTTechnologies.SupremeChemistry]       = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_BONUS },                                   new List<float>() { 1000.0f }),
            [CTTechnologies.SupremeStealth]         = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                new List<float>() { 0.001f }),
            [CTTechnologies.SuperCivilization]      = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_GAIN },                                    new List<float>() { 1.0f }),
            [CTTechnologies.ArtificialIntelligence] = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                  new List<float>() { 0.001f }),
            [CTTechnologies.InhumanForesight]       = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                 new List<float>() { 0.001f }),
            [CTTechnologies.RobotWorkers]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                      new List<float>() { 0.001f }),
            [CTTechnologies.AlienMastery]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                  new List<float>() { 0.001f }),
            [CTTechnologies.AlienSuperiority]       = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                new List<float>() { 0.001f }),
            [CTTechnologies.AlienDomination]        = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_GAIN },                                   new List<float>() { 0.001f }),
