...
namespace CT.Lookup
{
    ...
    public static class DataSheet
    {
        ...
        public static readonly Dictionary<CTTechnologies, BuffsNerfs> technology_buffs = new Dictionary<CTTechnologies, BuffsNerfs>()
        {
            ...
            [CTTechnologies.FinanceManagement]      = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS, BuffsNerfsType.MONEY_CAPACITY },      new List<float>() { 2500.0f, 2500.0f }),
            [CTTechnologies.AlarmSystem]            = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SAFETY_FACTOR },                                   new List<float>() { 3.0f }),
            [CTTechnologies.ResearchCentre]         = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_CAPACITY, BuffsNerfsType.SCIENCE_BONUS },  new List<float>() { 500.0f, 500.0f }),
            ...
            [CTTechnologies.Digitization]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.MONEY_BONUS, BuffsNerfsType.MONEY_CAPACITY },      new List<float>() { 3500.0f, 3500.0f }),
            ...
            [CTTechnologies.Alchemy]                = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_CAPACITY, BuffsNerfsType.SCIENCE_BONUS },  new List<float>() { 750.0f, 750.0f }),
            ...
            [CTTechnologies.ResearchDome]           = new BuffsNerfs(new List<BuffsNerfsType>() { BuffsNerfsType.SCIENCE_BONUS, BuffsNerfsType.SCIENCE_CAPACITY },  new List<float>() { 2000.0f, 1000.0f }),
